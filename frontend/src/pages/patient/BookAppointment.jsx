...
export default function BookAppointment() {
  ...
  const handleDateChange = async (e) => {
    ...
    try {
      const res = await api.getDoctorBookedSlots(doctorId, date)
  ...
  const slotsForDay = (
    availability.find((a) => a.dayOfWeek === form.selectedDay)?.slots || []
  ).filter((slot) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Appointment request sent! Waiting for doctor confirmation.')
    ...
    return (
      <div className="page-wrapper">
        <div className="container" style={{ maxWidth: 700 }}>
          <div className="error-msg" style={{ marginTop: 40 }}>
    ...
    <div className="page-wrapper">
      <div className="container" style={{ maxWidth: 700 }}>
            ...
            <div>
              ...
              >
                ...
                <span style={{ fontWeight: 600, color: 'var(--text)' }}>
                  LKR {doctor.consultationFee?.toLocaleString()} / session
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="info-banner" style={{ marginBottom: 16 }}>
          ℹ️ Your appointment request will first wait for doctor confirmation. The slot is secured only after payment is completed.
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {form.appointmentDate && (
              <div className="form-group">
                <label className="form-label">
                  Available Time Slots — {form.selectedDay}
                </label>
                  ...
                  >
                    {slotsForDay.map((slot) => {
                      const isSelected =
                        ...
                        form.selectedSlot?.endTime === slot.endTime
            ...
            {form.selectedSlot && (
              ...
              >
                ...
                >
                  ⚠️ This slot will be secured only after payment is completed.
                </div>
              </div>
            )}
